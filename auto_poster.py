...
def generate_post(campaign, keyword):
    ...
    profile_prompt = f"당신은 30~50대를 위한 전문 '평생직업 및 중장년 유망 자격증 전문 커리어 설계사'입니다. 주요 전문 분야: '연령 제한 없는 국가공인 유망 자격증 추천, 취득 기간 대비 가성비, 은퇴 후 취업 및 실무 활용처'. '{keyword}'의 타겟 유저가 가장 갈망하는 혜택과 현실적 고민이 무엇인지 전문가의 시각에서 3문장으로 날카롭게 분석하세요."
